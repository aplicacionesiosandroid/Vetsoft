...
class DirecCorreEmpScreen extends StatelessWidget {
  const DirecCorreEmpScreen({super.key});
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "Esta es la dirección de correo electrónico asociada a su cuenta.",
                                style: TextStyle(
                                    fontFamily: 'inter',
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                  onPressed: () {
                                    _showModalBottomSheetEditCorreo(
                                        context, sizeScreen);
                                  },
  ...
  void _showModalBottomSheetEditCorreo(BuildContext context, Size sizeScreen) {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 20.0),
              Text(
                'Introduzca su nueva dirección de corrreo electrónico',
                style: TextStyle(
              ...
              TextFormFieldConHint(
                  ...
                  hintText: 'Email', colores: ColorPalet.secondaryLight),
              ...
              TextFormFieldConHint(
                  ...
                  hintText: 'Contraseña', colores: ColorPalet.secondaryLight),
              SizedBox(height: 20.0),
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      final userProvider = Provider.of<UserEmpProvider>(context, listen: false);
                      bool success = await userProvider.changeEmail(
                        passwordController.text.trim(),
                        newEmailController.text.trim(),
                      );
                      Navigator.of(context).pop();
                      if (success) {
                        _mostrarFichaCreada(context, 'Email actualizado correctamente.');
                      } else {
                        _mostrarFichaCreada(context, 'Error al actualizar el email.');
                      }
                    },
                    style: ElevatedButton.styleFrom(
                        elevation: 0,

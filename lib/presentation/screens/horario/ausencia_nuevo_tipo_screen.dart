...
class AusenciasNuevoTipoScreen extends StatelessWidget {
  const AusenciasNuevoTipoScreen({super.key});
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AusenciasNuevoTipoProvider(),
      child: _AusenciasNuevoTipoScreen(),
    );
  }
}

class _AusenciasNuevoTipoScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ausenciasNuevoTipoProvider = Provider.of<AusenciasNuevoTipoProvider>(context);

    if (ausenciasNuevoTipoProvider.isLoading) return const LoadingScreen();

    return ChangeNotifierProvider<AusenciasNuevoTipoProvider>(
      create: (_) => AusenciasNuevoTipoProvider(),
      child: Consumer<AusenciasNuevoTipoProvider>(
  ...
  void _crearTipoAusencia(BuildContext context) async {
    final provider = Provider.of<AusenciasNuevoTipoProvider>(context, listen: false);
    ...
    try {
      await provider.postCrearAusencia(nombreTipoAusenciaController.text, solicitudMinimaController.text, maximoSolicitudesController.text, colorHex);
      mostrarSnackBar(context, 'Tipo de ausencia creado con éxito');
    } catch (e) {
      mostrarSnackBar(context, 'Error al crear tipo de ausencia: $e');
    }
  ...
  Widget _buildColorOptions() {
    return Consumer<AusenciasNuevoTipoProvider>(
  ...
  Widget _colorOption(BuildContext context, Color color, AusenciasNuevoTipoProvider provider) {

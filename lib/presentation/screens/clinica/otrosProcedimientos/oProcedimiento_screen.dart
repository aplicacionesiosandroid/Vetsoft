...
class ButtonNuevoRegistroOProced extends StatelessWidget {
  final List<ResultBusPacientes> listaPacientesBusq;

  ButtonNuevoRegistroOProced({super.key, required this.listaPacientesBusq});
        ...
        children: [
          Container(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  var procEspecialProvider =
                      Provider.of<OProcedimientosProvider>(context,
                          listen: false);
                  procEspecialProvider.setSelectSquareOproced(0);
                  procEspecialProvider.resetearDatosForm();
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(15),
                              border: Border.all(
                                color: Provider.of<OProcedimientosProvider>(
                                                context)
                                            .selectedSquareOProced ==
                                        1
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        fontFamily: 'sans',
                                        color:
                                            Provider.of<OProcedimientosProvider>(
                                                            context)
                                                        .selectedSquareOProced ==
                                                    1
                                                ? Color.fromARGB(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          if (Provider.of<OProcedimientosProvider>(context,
                                      listen: false)
                                  .selectedSquareOProced ==
                              1) {
                            Navigator.of(context).pop();
                            _openModalBottomSheetOProcedimiento(context);
                          } else if (Provider.of<OProcedimientosProvider>(
                                      context,
                                      listen: false)
                                  .selectedSquareOProced ==
                              2) {
  ...
  void _openAlertDialogBuscarPaciente(
    ...
    final oProcedimProvider =
        Provider.of<OProcedimientosProvider>(context, listen: false);
    oProcedimProvider.filtrarLista(listaPacientesBusq, "");
    showDialog(
      context: context,
      builder: (context) {
          ...
          content: SizedBox(
            ...
            child: Column(
              children: [
                TextFormField(
                  onChanged: (query) {
                    oProcedimProvider.filtrarLista(listaPacientesBusq, query);
                  },
                ...
                Flexible(
                  child: Container(
                    height: 300,
                    width: 300,
                    child: Consumer<OProcedimientosProvider>(
                        builder: (context, oProcedimProviderC, _) {
                      final listaFiltrada = oProcedimProviderC.listaFiltrada;
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          bool isSelected =
                              index == oProcedimProviderC.selectedIndexPaciente;
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                          onPressed: () {
                            if (oProcedimProvider.selectedIndexPaciente != -1) {
                              oProcedimProvider.setSelectedIdPacienteAntiguo(
                                  pacienteSeleccionado.toString());
                              print(' aqui esta el id del paciente anitugo' +
                                  oProcedimProvider.selectedIdPacienteAntiguo);
                              Navigator.of(context).pop();
                              _openModalBottomSheetOProcedimiento(context);
                            }
                          },
...
void _openModalBottomSheetOProcedimiento(BuildContext context) {
        ...
        child: Padding(
          ...
          child: WillPopScope(
            ...
            child:
              ...
              Flexible(
                child: FormularioOProcedimiento(),
              ),
            ]),
          ),
        ),
...
class ButtonProgramarCitaGeneralClinica extends StatelessWidget {
  final List<ResultBusPacientes> listaPacientesBusq;
  ...
  @override
  Widget build(BuildContext context) {
    // ProgramarCitaProvider listaBusPacientesProv = Provider.of<ProgramarCitaProvider>(context, listen: true);
    // List<ResultBusPacientes> listaPacientesBusq = listaBusPacientesProv.getResultadoBusquedasPaciente;
    final sizeScreen = MediaQuery.of(context).size;
  ...
  void _modalConsultaNuevoRegistro(BuildContext context,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(
                                    IconlyLight.add_user,
                                    size: 35,
                                    color: Provider.of<ProgramarCitaProvider>(
                                                    context)
                                                .selectedSquarePCita ==
                                            1
                                        ? Color.fromARGB(255, 1, 161, 197)
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        fontFamily: 'sans',
                                        color:
                                            Provider.of<ProgramarCitaProvider>(
                                                            context)
                                                        .selectedSquarePCita ==
                                                    1
                                                ? Color.fromARGB(
                      ...
                      ElevatedButton(
                        style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor:
                                const Color.fromARGB(255, 28, 149, 187)),
                        onPressed: () {
                          if (Provider.of<ProgramarCitaProvider>(context,
                                      listen: false)
                                  .selectedSquarePCita ==
                              1) {
                            Navigator.of(context).pop();
                            openModalBottomSheetProgramarCita(context);
                          } else if (Provider.of<ProgramarCitaProvider>(context,
                                      listen: false)
                                  .selectedSquarePCita ==
                              2) {
                            Navigator.of(context).pop();
              ...
              children: [
                ...
                Flexible(
                  child: Container(
                    height: 300,
                    width: 300,
                    child: Consumer<ProgramarCitaProvider>(
...
void openModalBottomSheetUpdateCita(
    BuildContext context, ClinicaModel clinica) {
  showModalBottomSheet(
    backgroundColor: Colors.white,
    enableDrag: false,
    isDismissible: false,
        ...
        child: Padding(
          ...
          child: WillPopScope(
            ...
            child:
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Flexible(
                child: FormularioUpdateCita(clinica: clinica),
              ),
            ]),
          ),
        ),
...
class ButtonPacientesOProced extends StatelessWidget {
  final List<ResultBusPacientes> listaPacientesBusq;

  ButtonPacientesOProced({super.key, required this.listaPacientesBusq});
...
class FormularioOProcedimiento extends StatefulWidget {
  @override
  _FormularioOProcedimientoState createState() =>
      _FormularioOProcedimientoState();
}
...
class _FormularioOProcedimientoState extends State<FormularioOProcedimiento> {
  ...
  final _formKeyDuenoProcEspecial = GlobalKey<FormState>();
  final _formkeyDatosPaciente = GlobalKey<FormState>();
  final _formkeyDatosProcedimiento = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    ...
    OProcedimientosProvider dataOProced =
        Provider.of<OProcedimientosProvider>(context, listen: true);
    List<EncargadosVete> listaVeterinarios = dataOProced.getEncargados;
    double valueLinearProgress = dataOProced.selectedSquareOProced == 2 ? 3 : 5;
              ...
              child: PageView(
                ...
                children: dataOProced.selectedSquareOProced == 2
                    ? [
                        ...
                        _datosProximaVisita(
                            dataOProced, sizeScreenWidth, listaVeterinarios),
                        _datosFacturacion(
                            dataOProced, sizeScreenWidth, listaVeterinarios)
                      ]
                    : [
                        _datosDelDueno(dataOProced, sizeScreenWidth),
                        _datosPaciente(dataOProced, sizeScreenWidth),
                        _datosOtroProced(dataOProced, sizeScreenWidth),
                        _datosProximaVisita(
                            dataOProced, sizeScreenWidth, listaVeterinarios),
                        _datosFacturacion(
  ...
  Widget _datosDelDueno(
      OProcedimientosProvider dataVacuna, double sizeScreenWidth) {
    return datosDelDueno(
        formKey: _formKeyDuenoProcEspecial,
  ...
  Widget _datosPaciente(
      OProcedimientosProvider dataOProced, double sizeScreenWidth) {
    return datosPaciente(
        ...
        generoProvider: dataOProced.selectedSexoPaciente,
        ...
        razaWidget: Consumer<OProcedimientosProvider>(
        ...
        imagenWidget: dataOProced.image != null
  ...
  Widget _datosOtroProced(
    ...
    return SingleChildScrollView(
      child: Container(
        color: Colors.white,
        child: Form(
          key: _formkeyDatosProcedimiento,
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            TextFormFieldConHintValidator(
                colores: const Color.fromARGB(255, 140, 228, 233),
                controller: controllerTipoDeProcedimiento,
            ...
            MensajeValidadorSelecciones(
              validator: (_) => dataOProced.fileArchivoOProcedimiento == ''
                  ? 'Añade un archivo.'
                  : null,
            ),
            _separacionCampos(20),
            Container(
              ...
              child: ElevatedButton(
                  onPressed: () {
                    if (_formkeyDatosProcedimiento.currentState!.validate()) {
                      _nextPage();
                    }
                  },
                  style: ElevatedButton.styleFrom(
  ...
  Widget _datosProximaVisita(OProcedimientosProvider dataOProced,
        ...
        child: Form(
          ...
          child: Column(
              ...
              children: [
                                    ...
                                    return ListTile(
                                      ...
                                      onTap: () {
                                        guardarIdVetEncargado(
                                            context, veterinario, dataOProced);
                                      },
                                    );
                                  },
                                ),
                ...
                MensajeValidadorSelecciones(
                  validator: (value) {
                    if (dataOProced.idEncargadoSelected == '') {
  ...
  Widget _datosFacturacion(OProcedimientosProvider dataOProced,
      double sizeScreenWidth, List<EncargadosVete> listaVeterinarios) {
    return SingleChildScrollView(
      child: Container(
        color: Colors.white,
        child: Form(
          ...
          child: Column(
              ...
              children: [
                ...
                _separacionCampos(20),
                DatosFacturacion<OProcedimientosProvider>(
                  providerGenerico: dataOProced,
                  sizeScreenWidth: sizeScreenWidth,
                  radioButtons: const [
                ...
                //     Spacer(),
                //     _NombreCampos('${dataOProced.totalACobrarFacturacion} Bs.'),
                //   ],
                // ),
                // _separacionCampos(20),
                Container(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        if (dataOProced.totalACobrarFacturacion.isEmpty) {
                          dataOProced.setTotalACobrarFacturacion =
                              controllerMontoEfectivo.text;
                        }
                        if (_formkeyFacturacion.currentState!.validate()) {
                          dataOProced.selectedSquareOProced == 2
                              ? dataOProced
                                  .enviarDatosAntiguo(
                                      //paciente
                                      dataOProced.selectedIdPacienteAntiguo,
                                      //otro procedimiento
                                      ...
                                      //datos facturacion
                                      dataOProced.selectedEfectivoTransac,
                                      controllerCIoNit.text,
                                      controllerNombreFactura.text,
                                      controllerApellidoFactura.text,
                                      dataOProced.switchValueFacturacion,
                                      dataOProced.totalACobrarFacturacion)
                                  .then((_) async {
  ...
  void _openTimePicker(
      BuildContext context, OProcedimientosProvider dataOProced) {
    final timePicker = TimePickerHelper<OProcedimientosProvider>(
      context: context,
      provider: dataOProced,

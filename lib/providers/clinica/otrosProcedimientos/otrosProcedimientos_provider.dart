...
class OProcedimientosProvider extends ChangeNotifier {
  ...
  int _selectedSquareOProced = 0;
  int get selectedSquareOProced => _selectedSquareOProced;

  void setSelectSquareOproced(int square) {
    _selectedSquareOProced = square;
    notifyListeners();
  }
  ...
  bool _loadingDatosOProcedimientos = false;
  bool get loadingDatosOProcedimientos => _loadingDatosOProcedimientos;

  setLoadingDatosOProcedimientos(bool value) {
    _loadingDatosOProcedimientos = value;
    notifyListeners();
  }

  //cambio a true si el POST se realizo de manera correcta
  bool _OKpostDatosOProcedimientos = false;
  bool get OkpostDatosOProcedimientos => _OKpostDatosOProcedimientos;

  setOKsendDatosOProcedimientos(bool value) {
    _OKpostDatosOProcedimientos = value;
    notifyListeners();
  }
  ...
  String _fileArchivoOProcedimiento = '';

  String get fileArchivoOProcedimiento => _fileArchivoOProcedimiento;

  void setArchivoOProcedimiento(String value) {
    _fileArchivoOProcedimiento = value;
    notifyListeners();
  }
  ...
  Future<bool> enviarDatos(
    ...
    String urlFinal = '${_urlBase}clinica/ficha-procedimiento';

    setLoadingDatosOProcedimientos(true);
    ...
    try {
      ...
      //DATOS otro procedimiento

      request.fields['procedimiento[procedimiento]'] = tipoDespf;

      request.files.add(await http.MultipartFile.fromPath(
          'archivo[procedimiento]', archivoOProcedf));
      ...
      if (responseData['code'] == 200 &&
        ...
        setLoadingDatosOProcedimientos(false);
        setOKsendDatosOProcedimientos(true);
        notifyListeners();
        return OkpostDatosOProcedimientos;
      } else {
  ...
  Future<bool> enviarDatosAntiguo(
    ...
    String urlFinal = '${_urlBase}clinica/ficha-procedimiento/$idPacientef';
  ...
  Future<bool> actualizarDatos(
    ...
    String urlFinal = '${_urlBase}update/ficha-procedimiento/${_fichaId}';
